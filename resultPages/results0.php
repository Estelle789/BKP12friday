             ...
             <div class="col-md-5" >
                <div class="container-fluid" style="margin-top:10px;margin-left:-250px;width:600px">
                    <div class="row">
                        ...
                        ?>
                            <div class="card mb-5">
                                <div class="card-body" style="background-color: #F3F9F0 ;border: 2px solid #0eb25a; height: 250px" >
                                  <div class="container-fluid">
                                     <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8" >
                                           <div class="row">
                                              <div class="col-md-9 resultName" style="width:200px"> <font size="5" ><strong><?php echo $row['id']; ?>. Hotel Amsterdam</strong> </font>
                                               <font size="3" style="color:blue" ><strong> Zanpad, 3A, Amsterdam </strong> </font>
                                              </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                   <div style="color:blue;padding-left:30px;padding-bottom:10px;padding-right:30px"><strong> Citizenm Amstel Amsterdam biedt kamers met airconditioning en een flatscreen-tv met satellietzenders in het centrum van Amsterdam. </strong></div>
                                </div>
                              </div>

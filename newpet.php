...
<div id="buttonsdiv">
    <p class="h1 font-weight-bold d-flex justify-content-center text-success">Choose your pet!</p>
    <a onclick="displaydog1()"><img src="public/images/add-dog.png" class="add-dog" data-toggle="tooltip" data-placement="bottom" title="Add a new dog" style="height:15%" alt="add-dog"></a>
    <a onclick="displaycat()"><img src="public/images/add-cat.png" class="add-cat"  data-toggle="tooltip" data-placement="bottom" title="Add a new cat" style="height:15%" alt="add-cat"></a>
</div>
</div>

<div id="dog1" style="display:none;" class="col-md-12 border border-success">
    <form action="newpet.php?p=2" method="post" id="dogform1">
        <h1 class="display-4 text-success font-weight-bold">Adding a new dog</h1>
        <input type="file" accept="image/*" name="image"><br>
        <label class="m-2 text-success font-weight-bold">Name*</label>
        <input class="form-control m-2" id="name" name="name" placeholder="name" required>
        ...
        <input id="dogsize" class="form-control m-2" name="dogsize" placeholder="hidden">
        <label class="m-2 text-success font-weight-bold">Date of birth</label>
        <input type="date" class="form-control m-2" name="birthdate" placeholder="date of birth">
        ...
        <input id="dogsex" class="form-control mt-2" name="sex" placeholder="hidden">
...
<div id="cat1" style="display:none;" class="col-md-12 border border-success">
    <h1 class="display-4 text-success font-weight-bold">Adding a new cat</h1>
    <form action="newpet.php?p=c2" method="post" id="catform1">
        <input type="file" accept="image/*" name="petimage"><br>
        <label label class="m-2 text-success font-weight-bold">Name*</label>
        <input class="form-control" id="catname" name="name" placeholder="name" required>
        ...
        <input id="catsex" class="form-control" name="sex" placeholder="hidden">
...
<div id="dog2" style="display:none"; class="col-md-12 border border-success">
    <form action="newpet.php?p=3" method="post" id="dogform2">
        <input type="file" accept="image/*" name="petimage">
        <input name="name" placeholder="name" value="<?php if (isset($_POST["name"])){echo $_POST["name"]; } ?>">
        <input name="sex" placeholder="name" value="<?php if (isset($_POST["sex"])){echo $_POST["sex"]; } ?>">
        <input name="dogsize" placeholder="name"
            value="<?php if (isset($_POST["dogsize"])){echo $_POST["dogsize"]; } ?>">
        <input type="date" name="birthdate" placeholder="date of birth"
            value="<?php if (isset($_POST["birthdate"])){echo $_POST["birthdate"]; } ?>">
        <input name="breed" value="<?php if (isset($_POST["breed"])){echo $_POST["breed"]; } ?>">
        <input name="chip" placeholder="Chip number" value="<?php if (isset($_POST["chip"])){echo $_POST["chip"]; } ?>">
        ...
        <div role="group" aria-label="First group">
            ...
            <input class="form-control" name="sterilized" id="sterilized" placeholder="hidden">
        </div>
        ...
        <input class="form-control" name="alongwithdogs" id="alongwithdogs" placeholder="hidden">
        ...
        <input class="form-control" name="alongwithchildren" id="alongwithchildren" placeholder="hidden">
        ...
        <input class="form-control" name="alongwithcats" id="alongwithcats" placeholder="hidden">
        <label class="m-2 text-success font-weight-bold">Explain your dog's walking routine</label>
        <textarea name="walkingroutine" class="m-2 align-middle" cols=84 placeholder="My dog usually..."></textarea>
        <label class="m-2 text-success font-weight-bold">Explain your dog's eating Routine</label>
        <textarea name="eatingroutine" class="m-2 align-middle" cols=84 placeholder="My dog usually..."></textarea>
        <label class="m-2 text-success font-weight-bold">Where does the dog sleep?</label>
        <textarea name="sleep_place" class="mr-6 align-middle" cols=84 placeholder="My dog usually..."></textarea>
...
<div id="cat2" style="display:none; width:800px; margin-left:20%; border:1px solid black;">
    <form action="newpet.php?p=c3" method="post" id="catform2">
        <input type="file" accept="image/*" name="petimage">
        <input name="name" placeholder="name" value="<?php if (isset($_POST["name"])){echo $_POST["name"];} ?>">
        <input name="sex" placeholder="name" value="<?php if (isset($_POST["sex"])){echo $_POST["sex"];} ?>">
        <input type="date" name="birthdate" placeholder="date of birth"
        ...
        <div role="group" aria-label="First group">
            ...
            <a onclick="csterilized('0')"><button id="csterilized0" style="width:49%" type="button"
                    class="btn btn-light">No</button></a>
            <input class="form-control" name="sterilized" id="csterilized" placeholder="hidden">
        </div>
        ...
        <input class="form-control" name="alongwithdogs" id="calongwithdogs" placeholder="hidden">
        ...
        <input class="form-control" name="alongwithchildren" id="calongwithchildren" placeholder="hidden">
        ...
        <input class="form-control" name="alongwithcats" id="calongwithcats" placeholder="hidden">
        <label class="m-2 text-success font-weight-bold">Explain your cat's eating Routine</label>
        <textarea name="eatingroutine" class="m-2 align-middle" cols=84 placeholder="My cat usually..."></textarea>
        <label class="m-2 text-success font-weight-bold">Where does the cat sleep?</label>
        <textarea name="sleep_place" class="m-2 align-middle" cols=84 placeholder="My cat usually..."></textarea>
...
<div id="dog3" style="display:none; width:800px; margin-left:20%; border:1px solid black;">
    <form action="includes/petowner/newpetfunc.php" method="post">
        <input type="file" accept="image/*" name="petimage">
        <input name="name" value="<?php if (isset($_POST["name"])){echo $_POST["name"];} ?>">
        <input name="sex" value="<?php if (isset($_POST["sex"])){echo $_POST["sex"];} ?>">
        <input name="dogsize" placeholder="name"
            value="<?php if (isset($_POST["dogsize"])){echo $_POST["dogsize"];} ?>">
        <input type="date" name="birthdate" value="<?php if (isset($_POST["birthdate"])){echo $_POST["birthdate"];} ?>">
        <input name="breed" value="<?php if (isset($_POST["breed"])){echo $_POST["breed"];} ?>">
        <input name="chip" value="<?php if (isset($_POST["chip"])){echo $_POST["chip"];} ?>">
        <input name="description" value="<?php if (isset($_POST["description"])){echo $_POST["description"];} ?>">
        <input name="sterilized" value="<?php if (isset($_POST["sterilized"])){echo $_POST["sterilized"];} ?>">
        <input name="alongwithdogs" value="<?php if (isset($_POST["alongwithdogs"])){echo $_POST["alongwithdogs"];} ?>">
        <input name="alongwithchildren"
            value="<?php if (isset($_POST["alongwithchildren"])){echo $_POST["alongwithchildren"];} ?>">
        <input name="alongwithcats" value="<?php if (isset($_POST["alongwithcats"])){echo $_POST["alongwithcats"];} ?>">
        <input name="walkingroutine"
            value="<?php if (isset($_POST["walkingroutine"])){echo $_POST["walkingroutine"];} ?>">
        <input name="eatingroutine" value="<?php if (isset($_POST["eatingroutine"])){echo $_POST["eatingroutine"];} ?>">
        <input name="sleep_place" value="<?php if (isset($_POST["sleep_place"])){echo $_POST["sleep_place"];} ?>">
        ...
        <input class="form-control" name="vaccinations" id="vaccinations" placeholder="hidden">
        ...
        <input class="form-control" name="kennel" id="kennel" placeholder="hidden">
        <label class="m-2 text-success font-weight-bold">Does the dog have any allergies?</label>
        <textarea name="allergies" class="ml-2" cols=84 placeholder="Leave empty if it is not the case"></textarea>
        <label class="m-2 text-success font-weight-bold">Is your dog on any medication?</label>
        <textarea name="medication" class="ml-2" cols=84 placeholder="Leave empty if it is not the case"></textarea>
        <label class="m-2 text-success font-weight-bold">Vet's name</label>
        <input class="form-control" name="vetname" placeholder="Vet's name">
        <label class="m-2 text-success font-weight-bold">Vet's phone</label>
        <input class="form-control" name="vetphone" placeholder="Vet's phone">
        <label class="m-2 text-success font-weight-bold">Vet's address</label>
        <input class="form-control" name="vetaddress" placeholder="Vet's address">
        <label class="m-2 text-success font-weight-bold">Insurer</label>
        <input class="form-control" name="insurer" placeholder="Insurer">
        <label class="m-2 text-success font-weight-bold">Insurer's policy number</label>
        <input class="form-control" name="policynumber" placeholder="Insurer's policy number">
        <label class="m-2 text-success font-weight-bold">Emergency contact phone</label>
        <input class="form-control" name="emergencycontact" placeholder="Emergency contact phone">
...
<div id="cat3" style="display:none; width:800px; margin-left:20%; border:1px solid black;">
    <form action="includes/petowner/newpetfunc.php" method="post">
        ...
        <input name="name" value="<?php if (isset($_POST["name"])){echo $_POST["name"]; }; ?>">
        <input name="sex" value="<?php if (isset($_POST["sex"])){echo $_POST["sex"];}; ?>">
        <input name="birthdate" value="<?php if (isset($_POST["birthdate"])){echo $_POST["birthdate"];}; ?>">
        <input name="breed" value="<?php if (isset($_POST["breed"])){echo $_POST["breed"];}; ?>">
        <input name="chip" value="<?php if (isset($_POST["chip"])){echo $_POST["chip"];}; ?>">
        <input name="description" value="<?php if (isset($_POST["description"])){echo $_POST["description"];}; ?>">
        <input name="sterilized" value="<?php if (isset($_POST["sterilized"])){echo $_POST["sterilized"];}; ?>">
        <input name="alongwithdogs"
            value="<?php if (isset($_POST["alongwithdogs"])){echo $_POST["alongwithdogs"];}; ?>">
        <input name="alongwithchildren"
            value="<?php if (isset($_POST["alongwithchildren"])){echo $_POST["alongwithchildren"];}; ?>">
        <input name="alongwithcats"
            value="<?php if (isset($_POST["alongwithcats"])){echo $_POST["alongwithcats"];}; ?>">
        <input name="walkingroutine"
            value="<?php if (isset($_POST["walkingroutine"])){echo $_POST["walkingroutine"];}; ?>">
        <input name="eatingroutine"
            value="<?php if (isset($_POST["eatingroutine"])){echo $_POST["eatingroutine"];}; ?>">
        <input name="sleep_place" value="<?php if (isset($_POST["sleep_place"])){echo $_POST["sleep_place"];}; ?>">
...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-2" style="margin-bottom:400px">

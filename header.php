     ...
     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
       ...
       <div class="modal-content">
         <div class="modal-body">
           <a href="#" class="btn btn-outline-primary form-control " data-toggle="modal" onclick="invokeregister(2)" data-target="#registerform" style="margin-bottom:5px !important;">Register as a hotel owner</a>
           <a href="#" class="btn btn-outline-success form-control" data-toggle="modal" onclick="invokeregister(3)" data-target="#registerform">Register as a dog sitter</a>
         </div>
       </div>
     </div>
   </div>
